 ...
 * @property isDisposable A nullable boolean flag indicating whether the email address is associated with a disposable or temporary email service. `true` if it is, `false` otherwise, or `null` if unknown.
